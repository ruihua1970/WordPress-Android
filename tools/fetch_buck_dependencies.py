...
BASE_DEPENDENCIES ={
'android-support-v4': {'url': os.path.join(ANDROID_SDK_PATH, 'extras/android/m2repository/com/android/support/support-v4/23.0.0/support-v4-23.0.0.aar')},
'android-support-v13': {'url': os.path.join(ANDROID_SDK_PATH, 'extras/android/m2repository/com/android/support/support-v13/23.0.0/support-v13-23.0.0.aar')},
'cardview-v7': {'url': os.path.join(ANDROID_SDK_PATH, 'extras/android/m2repository/com/android/support/cardview-v7/23.0.0/cardview-v7-23.0.0.aar')},
'appcompat-v7': {'url': os.path.join(ANDROID_SDK_PATH, 'extras/android/m2repository/com/android/support/appcompat-v7/23.0.0/appcompat-v7-23.0.0.aar')},
'recyclerview-v7': {'url': os.path.join(ANDROID_SDK_PATH, 'extras/android/m2repository/com/android/support/recyclerview-v7/23.0.0/recyclerview-v7-23.0.0.aar')},
'design': {'url': os.path.join(ANDROID_SDK_PATH, 'extras/android/m2repository/com/android/support/design/23.0.0/design-23.0.0.aar')},
'support-annotations': {'url': os.path.join(ANDROID_SDK_PATH, 'extras/android/m2repository/com/android/support/support-annotations/23.0.0/support-annotations-23.0.0.jar')},
...
'passcodelock': {'url': 'https://search.maven.org/remotecontent?filepath=org/wordpress/passcodelock/1.0.0/passcodelock-1.0.0.aar'},
...
'wpcomrest': {'url': 'https://repo1.maven.org/maven2/com/automattic/rest/1.0.2/rest-1.0.2.aar'},
